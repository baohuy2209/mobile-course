...
import com.nguyenbaohuy.self_learning_2.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void openDB() {
        db = Database.getDb(MainActivity.this);
    }
...
//        listDishNoodle.add(new Dish("Bún Đậu Bún Chả - Cô Hường", "Bún Đậu Thịt Luộc", R.drawable.noodle_bun_dau_bun_cha, 4.2, "200+", "61 Hoàng Diệu 2, P. Linh Trung, Q. Thủ Đức, Tp.HCM"));
        ...
        Cursor c = db.query(Database.TABLE_DISH, null, null, null, null, null, null);

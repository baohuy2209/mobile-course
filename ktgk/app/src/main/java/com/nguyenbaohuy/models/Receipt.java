...
public class Receipt {
    ...
    public Receipt(int id, String receipt_name, String receipt_nat, String receipt_cl, String receipt_time, String level, Blob receipt_image, int category_id) {
        this.id = id;
    ...
    public Blob getReceipt_image() {
        return receipt_image;
    }

    public void setReceipt_image(Blob receipt_image) {
        this.receipt_image = receipt_image;
    }
